Feature: activating as aggregate order entity
  ...
  Scenario: I order product and change shipping address
    Given I active messaging for namespace "Test\Ecotone\DomainModel\Fixture\CommandHandler\Aggregate"
  ...
  This will focus on asynchronous scenario using inbound channel adapter
    Given I active messaging for namespace "Test\Ecotone\DomainModel\Fixture\Renter"
