...
use stdClass;
use Tests\Ecotone\Messaging\Fixture\Annotation\Interceptor\AroundInterceptorWithCustomParameterConverters;
use Tests\Ecotone\Messaging\Fixture\Annotation\Interceptor\CalculatingServiceInterceptorExample;
use Tests\Ecotone\Messaging\Fixture\Annotation\MessageEndpoint\ServiceActivator\AllConfigurationDefined\ServiceActivatorWithAllConfigurationDefined;
...
use Tests\Ecotone\Messaging\Fixture\Behat\Ordering\OrderProcessor;
use Tests\Ecotone\Messaging\Fixture\Converter\StringToUuidClassConverter;
use Tests\Ecotone\Messaging\Fixture\Handler\ExampleService;
use Tests\Ecotone\Messaging\Fixture\Handler\Processor\AroundInterceptorObjectBuilderExample;
use Tests\Ecotone\Messaging\Fixture\Handler\Processor\Interceptor\CallMultipleUnorderedArgumentsInvocationInterceptorExample;
use Tests\Ecotone\Messaging\Fixture\Handler\Processor\Interceptor\CallWithAnnotationFromClassInterceptorExample;
use Tests\Ecotone\Messaging\Fixture\Handler\Processor\Interceptor\CallWithAnnotationFromMethodInterceptorExample;
use Tests\Ecotone\Messaging\Fixture\Handler\Processor\Interceptor\CallWithEndingChainAndReturningInterceptorExample;
use Tests\Ecotone\Messaging\Fixture\Handler\Processor\Interceptor\CallWithEndingChainNoReturningInterceptorExample;
use Tests\Ecotone\Messaging\Fixture\Handler\Processor\Interceptor\CallWithInterceptedObjectInterceptorExample;
use Tests\Ecotone\Messaging\Fixture\Handler\Processor\Interceptor\CallWithNullableStdClassInterceptorExample;
use Tests\Ecotone\Messaging\Fixture\Handler\Processor\Interceptor\CallWithPassThroughInterceptorExample;
use Tests\Ecotone\Messaging\Fixture\Handler\Processor\Interceptor\CallWithProceedingAndReturningInterceptorExample;
use Tests\Ecotone\Messaging\Fixture\Handler\Processor\Interceptor\CallWithProceedingInterceptorExample;
use Tests\Ecotone\Messaging\Fixture\Handler\Processor\Interceptor\CallWithReferenceSearchServiceExample;
use Tests\Ecotone\Messaging\Fixture\Handler\Processor\Interceptor\CallWithReplacingArgumentsInterceptorExample;
use Tests\Ecotone\Messaging\Fixture\Handler\Processor\Interceptor\CallWithRequestMessageInterceptorExample;
use Tests\Ecotone\Messaging\Fixture\Handler\Processor\Interceptor\CallWithStdClassInterceptorExample;
use Tests\Ecotone\Messaging\Fixture\Handler\Processor\Interceptor\CallWithUnorderedClassInvocationInterceptorExample;
...
use Tests\Ecotone\Messaging\Fixture\Service\ServiceExpectingThreeArguments;
use Tests\Ecotone\Messaging\Fixture\Service\ServiceExpectingTwoArguments;
use Tests\Ecotone\Messaging\Fixture\Service\ServiceWithoutAnyMethods;
