...
namespace Tests\Ecotone\Modelling\Behat\Bootstrap;
...
use Tests\Ecotone\Messaging\Behat\Bootstrap\AnnotationBasedMessagingContext;
use Tests\Ecotone\Modelling\Fixture\CommandHandler\Aggregate\ChangeShippingAddressCommand;
use Tests\Ecotone\Modelling\Fixture\CommandHandler\Aggregate\CreateOrderCommand;
use Tests\Ecotone\Modelling\Fixture\CommandHandler\Aggregate\GetOrderAmountQuery;
use Tests\Ecotone\Modelling\Fixture\CommandHandler\Aggregate\GetShippingAddressQuery;
...
use Tests\Ecotone\Modelling\Fixture\EventSourcedAggregateWithInternalEventRecorder\FinishJob;
use Tests\Ecotone\Modelling\Fixture\EventSourcedAggregateWithInternalEventRecorder\StartJob;
use Tests\Ecotone\Modelling\Fixture\EventSourcingRepositoryShortcut\TwitWasCreated;
use Tests\Ecotone\Modelling\Fixture\InterceptedCommandAggregate\EventWasLogged;
use Tests\Ecotone\Modelling\Fixture\LateAggregateIdAssignation\CreateUser;
use Tests\Ecotone\Modelling\Fixture\MetadataPropagating\PlaceOrder;
use Tests\Ecotone\Modelling\Fixture\NamedEvent\AddGuest;
use Tests\Ecotone\Modelling\Fixture\NamedEvent\GuestViewer;
use Tests\Ecotone\Modelling\Fixture\NamedEvent\RegisterBook;
use Tests\Ecotone\Modelling\Fixture\RepositoryShortcut\Twitter;
use Tests\Ecotone\Modelling\Fixture\RepositoryShortcut\TwitterRepository;
use Tests\Ecotone\Modelling\Fixture\RepositoryShortcut\TwitterService;
use Tests\Ecotone\Modelling\Fixture\TwoSagas\Bookkeeping;
use Tests\Ecotone\Modelling\Fixture\TwoSagas\OrderWasPaid;
use Tests\Ecotone\Modelling\Fixture\TwoSagas\OrderWasPlaced;
use Tests\Ecotone\Modelling\Fixture\TwoSagas\Shipment;
...
class DomainContext extends TestCase implements Context
{
    ...
    public function orderWithIdWasPlaced(int $id)
    {
        ...
        AnnotationBasedMessagingContext::getEventBus()->publish(new \Tests\Ecotone\Modelling\Fixture\TwoAsynchronousSagas\OrderWasPlaced($id));
    }
    ...
    public function orderWithIdWasPaid(int $orderId)
    {
        ...
        AnnotationBasedMessagingContext::getEventBus()->publish(new \Tests\Ecotone\Modelling\Fixture\TwoAsynchronousSagas\OrderWasPaid($orderId));
    }
    ...
    public function twitWithIdDoesNotExists(string $id)
    {
        ...
        $twitterRepository = AnnotationBasedMessagingContext::getGateway(AnnotationBasedMessagingContext::getLoadedNamespaces() == ["Tests\Ecotone\Modelling\Fixture\RepositoryShortcut"] ? TwitterRepository::class : \Tests\Ecotone\Modelling\Fixture\EventSourcingRepositoryShortcut\TwitterRepository::class);
    ...
    {
        $isStatefulAggregate = AnnotationBasedMessagingContext::getLoadedNamespaces() == ["Tests\Ecotone\Modelling\Fixture\RepositoryShortcut"];

        /** @var TwitterRepository|\Tests\Ecotone\Modelling\Fixture\EventSourcingRepositoryShortcut\TwitterRepository $twitterRepository */
        $twitterRepository = AnnotationBasedMessagingContext::getGateway($isStatefulAggregate ? TwitterRepository::class : \Tests\Ecotone\Modelling\Fixture\EventSourcingRepositoryShortcut\TwitterRepository::class);
    ...
    {
        $isForStatefulAggregate = AnnotationBasedMessagingContext::getLoadedNamespaces() == ["Tests\Ecotone\Modelling\Fixture\RepositoryShortcut"];
        /** @var TwitterRepository $twitterRepository */
        $twitterRepository = AnnotationBasedMessagingContext::getGateway($isForStatefulAggregate ? TwitterRepository::class : \Tests\Ecotone\Modelling\Fixture\EventSourcingRepositoryShortcut\TwitterRepository::class);
        ...
        $twitterService = AnnotationBasedMessagingContext::getGateway($isForStatefulAggregate ? TwitterService::class : \Tests\Ecotone\Modelling\Fixture\EventSourcingRepositoryShortcut\TwitterService::class);
    ...
    {
        /** @var TwitterService $twitterRepository */
        $twitterService = AnnotationBasedMessagingContext::getGateway(AnnotationBasedMessagingContext::getLoadedNamespaces() == ["Tests\Ecotone\Modelling\Fixture\RepositoryShortcut"] ? TwitterService::class : \Tests\Ecotone\Modelling\Fixture\EventSourcingRepositoryShortcut\TwitterService::class);
    ...
    {
        AnnotationBasedMessagingContext::getCommandBus()->send(new \Tests\Ecotone\Modelling\Fixture\AggregateIdFromMethod\CreateUser($id, $name));
    }
    ...
    {
        $result = AnnotationBasedMessagingContext::getCommandBus()->sendWithRouting("user.create", new \Tests\Ecotone\Modelling\Fixture\LateAggregateIdAssignationWithAggregateIdFromMethod\CreateUser("Johny"));
