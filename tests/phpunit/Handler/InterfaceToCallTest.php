...
class InterfaceToCallTest extends TestCase
{
    ...
    public function test_retrieving_parameter_type_hint()
    {
        ...
        $this->assertEquals(
            InterfaceParameter::create("name", "string", false, ""),
    ...
    public function test_retrieving_parameter_type_hint_from_doc_block_guessing_namespace()
    {
        ...
        $this->assertEquals(
            InterfaceParameter::create("password", Password::class, false, "\\" . Password::class),
    ...
    public function test_retrieving_parameter_type_hint_from_global_namespace()
    {
        ...
        $this->assertEquals(
            InterfaceParameter::create("details", InterfaceParameter::UNKNOWN, true, "\\stdClass"),
    ...
    public function test_retrieving_parameter_type_hint_from_different_namespace_than_class_it_self()
    {
        ...
        $this->assertEquals(
            InterfaceParameter::create("favourites", InterfaceParameter::ARRAY, false, "array<Fixture\Conversion\Extra\Favourite>"),
    ...
    public function test_retrieving_parameter_type_hint_from_different_namespace_using_use_statements()
    {
        ...
        $this->assertEquals(
            InterfaceParameter::create("favourite", Favourite::class, false, "\Fixture\Conversion\Extra\Favourite"),
    ...
    public function test_retrieving_parameter_type_hint_with_use_statement_alias()
    {
        ...
        $this->assertEquals(
            InterfaceParameter::create("adminPermission", Permission::class, false, "\\" . Permission::class),
    ...
    public function test_retrieving_parameter_type_hint_with_collection_of_scalar_type()
    {
        ...
        $this->assertEquals(
            InterfaceParameter::create("ratings", InterfaceParameter::ITERABLE, false, "array<int>"),
    ...
    public function test_retrieving_parameter_type_hint_with_primitive_type()
    {
        ...
        $this->assertEquals(
            InterfaceParameter::create("rating", InterfaceParameter::INTEGER, false, "int"),
    ...
    public function test_guessing_parameter_type_hint_from_scalar_and_compound_type()
    {
        ...
        $this->assertEquals(
            InterfaceParameter::create("random", InterfaceParameter::UNKNOWN, true, "array"),
    ...
    public function test_guessing_parameter_type_hint_from_compound_and_collection()
    {
        ...
        $this->assertEquals(
            InterfaceParameter::create("phones", InterfaceParameter::UNKNOWN, true, "array<string>"),
    ...
    public function test_guessing_parameter_type_hint_from_scalar_and_class_name()
    {
        ...
        $this->assertEquals(
            InterfaceParameter::create("email", InterfaceParameter::UNKNOWN, true, "\\" . Email::class),
